...
class ClassSchduler:
    ...
    def MainScheduler(self,jobList,resources ):
        ...
        for du in range(Set.duration):                    # for specified time
            ...
            """evaluate and apply addressability of job and put in resource POOL """
            ...
            for waiting in self.shadowQueue:
                ...
                self.evaluateCurrentResource.sort(key=(lambda resource:
                                                       (resource[self.rCore] - (waiting[self.execs][self.head][self.VMcore]))))#, reverse=True)
                ...
                if Set.MEO:
                    ...
                    while len(self.evaluateScaleability)!=0:
                        ...
                        self.shadowResources.sort(key=(lambda resource:
